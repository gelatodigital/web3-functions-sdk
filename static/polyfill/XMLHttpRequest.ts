...
export function needsEncoding(s: string): boolean {
  for (const b of s) {
    ...
    if (
      (charCode < CHAR_CODE_SPACE || charCode > CHAR_CODE_TILDE) &&
      b !== "\t"
    ) {
      return true;
    }
...
export function getCharset(type: string): string | undefined {
  try {
    ...
    const entry = db[mediaType as any] as any;
...
(function populateMaps() {
  ...
  for (const type of Object.keys(db) as any[]) {
    const mime = db[type] as any;
    ...
    for (const ext of exts) {
      ...
      if (current) {
        const from = preference.indexOf((db[current] as any).source);
...
export function contentType<T>(extensionOrType: any): string | undefined {
  try {
...
function extractLength(response: any) {
...
function extractMIMEType(headers: any) {
...
export class XMLHttpRequestEventTarget extends EventTarget {
  onabort: ((this: XMLHttpRequest, ev: any) => any) | null = null;
  onerror: ((this: XMLHttpRequest, ev: any) => any) | null = null;
  onload: ((this: XMLHttpRequest, ev: any) => any) | null = null;
  onloadend: ((this: XMLHttpRequest, ev: any) => any) | null = null;
  onloadstart: ((this: XMLHttpRequest, ev: any) => any) | null = null;
  onprogress: ((this: XMLHttpRequest, ev: any) => any) | null = null;
  ontimeout: ((this: XMLHttpRequest, ev: any) => any) | null = null;
...
export class XMLHttpRequest extends XMLHttpRequestEventTarget {
  ...
  onreadystatechange: ((this: XMLHttpRequest, ev: any) => any) | null = null;
